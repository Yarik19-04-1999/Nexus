...
namespace Nexus.Core.Integration.Tests.Fixtures;

public abstract class NexusSqlFixture : ContainerFixture<MsSqlBuilder, MsSqlContainer>
{
    protected NexusSqlFixture(IMessageSink messageSink) : base(messageSink)
    {
    }
